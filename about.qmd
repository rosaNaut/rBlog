...
<div class="grid">
  ...
  <div class="g-col-6">
    ...
    I am trained to operate several types of laboratorial instruments, such as (...). To help me learn how to operate all these equipments I have created various guidelines, where you can check them out by cliking here or going to the guides section. 
    </p><p>
    Finally, you can check all my (...) by visiting my linkedin page, or by cliking here.
     </p> 
  </div>
</div>
```
